...
Chrome (title-bar controls, bevels, gel buttons, scanlines, traffic lights) comes from each theme's **engine**: `bevel`, `luna`, `aero`, `system7`, `platinum`, `aqua`, `nextstep`, `beos`, `amiga`, `pixel`, `terminal`, `web`, `soft`, `graphic`, `glass`, `fluent`.
